...
songs_lda_3 <- LDA(songs_dtm, k = 3, control = list(seed = 1234))
songs_lda_2 <- LDA(songs_dtm, k = 2, control = list(seed = 1234))


# save(songs_lda, file = "objects/songs_lda_2.RDA")

# load(file = "objects/songs_lda_4.RDA")
load(file = "objects/songs_lda_3.RDA")
# load(file = "objects/songs_lda_2.RDA")
